...
class Ui_scrollArea(object):
    ...
    def retranslateUi(self, scrollArea):
        self.start_edit.setText(QCoreApplication.translate("scrollArea", u"300", None))
        self.start_edit.setPlaceholderText(QCoreApplication.translate("scrollArea", u"from, nm", None))
        self.step_edit.setText(QCoreApplication.translate("scrollArea", u"5", None))
        self.step_edit.setPlaceholderText(QCoreApplication.translate("scrollArea", u"step, nm", None))
        self.label_start.setText(QCoreApplication.translate("scrollArea", u"Start \u03bb", None))
        self.delay_edit.setText(QCoreApplication.translate("scrollArea", u"0", None))
        self.delay_edit.setPlaceholderText(QCoreApplication.translate("scrollArea", u"delay, s", None))
        self.label_stop.setText(QCoreApplication.translate("scrollArea", u"Stop \u03bb", None))
        self.label_delay.setText(QCoreApplication.translate("scrollArea", u"Delay", None))
        self.label_step.setText(QCoreApplication.translate("scrollArea", u"\u0394\u03bb", None))
        self.stop_edit.setText(QCoreApplication.translate("scrollArea", u"2000", None))
        self.stop_edit.setPlaceholderText(QCoreApplication.translate("scrollArea", u"to, nm", None))
        self.sample_edit.setText("")
        self.sample_edit.setPlaceholderText(QCoreApplication.translate("scrollArea", u"sample_name", None))
        self.label_sample.setText(QCoreApplication.translate("scrollArea", u"Sample", None))
        self.nplc_edit.setText(QCoreApplication.translate("scrollArea", u"1", None))
        self.nplc_edit.setPlaceholderText(QCoreApplication.translate("scrollArea", u"0.01 - 10.00", None))
        self.average_edit.setText(QCoreApplication.translate("scrollArea", u"1", None))
        self.average_edit.setPlaceholderText(QCoreApplication.translate("scrollArea", u"1 - 100", None))
        self.channel1_radio.setText(QCoreApplication.translate("scrollArea", u"1", None))
        self.channel2_radio.setText(QCoreApplication.translate("scrollArea", u"2", None))
        self.label_channel.setText(QCoreApplication.translate("scrollArea", u"Channel", None))
        self.voltage_check.setText("")
        self.label_nplc.setText(QCoreApplication.translate("scrollArea", u"NPLC", None))
        self.voltage_edit.setText(QCoreApplication.translate("scrollArea", u"0", None))
        self.voltage_edit.setPlaceholderText(QCoreApplication.translate("scrollArea", u"voltage: \u00b110 V", None))
        self.average_check.setText("")
        self.label_average.setText(QCoreApplication.translate("scrollArea", u"Average", None))
        self.label_voltage.setText(QCoreApplication.translate("scrollArea", u"Voltage", None))
        self.label_shutter.setText(QCoreApplication.translate("scrollArea", u"Shutter", None))
        self.wl_edit.setText("")
        self.wl_edit.setPlaceholderText(QCoreApplication.translate("scrollArea", u"300 - 2000 nm", None))
        self.shutter_check.setText("")
        self.label_setwl.setText(QCoreApplication.translate("scrollArea", u"Set  \u03bb", None))
        self.start_button.setText(QCoreApplication.translate("scrollArea", u"Start", None))
        self.stop_button.setText(QCoreApplication.translate("scrollArea", u"Stop", None))
        pass
    # retranslateUi
